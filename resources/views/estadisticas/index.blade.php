...
<div class="row">
    <div class="col l6">
        <div class="card">
            <div class="card-content">
                <div class="card-title">Pagos del año</div>
    ...
    <div class="col l12">
        <div class="card">
            <div class="card-content">
                <div class="card-title">Gastos del año</div>
                <div class="divider"></div>
                <br>
...
<script>
    ...
    var tranferencias = "<?php echo $transferencias; ?>";
    var cheque = "<?php echo $cheques; ?>";
